...
# also add new translations to src/qt/eltoken.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/eltoken_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/eltoken.rc
...
windows:RC_FILE = src/qt/res/eltoken.rc
...
macx:ICON = src/qt/res/icons/eltoken.icns
macx:TARGET = "eltoken"
