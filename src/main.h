...
public:
    ...
    /** Amount of eltokens spent by this transaction.
    ...
    int64_t GetValueOut() const
    {
        ...
        BOOST_FOREACH(const CTxOut& txout, vout)
        {
            if(txout.nUnlockHeight > 0)
                nValueOut += GetLockPrincipal(GetHash(), txout);
            else
    ...
    /** Amount of eltokens coming in to this transaction
