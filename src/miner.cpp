...
// Copyright (c) 2017 The Eltoken developers
...
static string strMiners[POW_MINER_SIZE] = {
    "EV5dpab2NsDqeqW6CTyFx3j4pvP72DCNLG",
    "ERBMMQ7kfEA7e5m8fiqsiSaQWS8pumMEPP",
    "EVMhLWbcKafzVBz5czZW2Mw1QCaLMczLx9",
    "EWmcCjFWGzyXrH5aamruK7wCbmDDLrTo7a",
    "ENnD2VtWAeTNEagLgdtHo4aE6vHE17Zzjy"
};
...
void ThreadPoWMiner(CWallet* pwallet)
{
    ...
    RenameThread("eltoken-pow-miner");
...
void ThreadStakeMiner(CWallet *pwallet)
{
    ...
    RenameThread("eltoken-stake-miner");
