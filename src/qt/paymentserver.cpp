...
const QString BITCOIN_IPC_PREFIX("eltoken:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click eltoken: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start eltoken: click-to-pay handler");
    else
...
{
    // clicking on eltoken: URLs creates FileOpen events on the Mac:
