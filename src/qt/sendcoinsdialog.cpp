    ...
    model(0)
{
    ...
    setStyleSheet("QFrame#frameCoinControl{ background: rgb(255, 255, 255); border: 1px solid rgb(206, 206, 206); }"
                  "QWidget#widgetCoinControl{ background: rgb(255, 255, 255); }"
                  "QLabel#labelCoinControlFeatures, QLabel#labelCoinControlAutomaticallySelected, QLabel#labelCoinControlInsuffFunds, QLabel#labelCoinControlQuantityText, QLabel#labelCoinControlQuantity, QLabel#labelCoinControlBytesText, QLabel#labelCoinControlBytes, QLabel#labelCoinControlAmountText, QLabel#labelCoinControlAmount, QLabel#labelCoinControlFeeText, QLabel#labelCoinControlFee, QLabel#labelCoinControlLowOutputText, QLabel#labelCoinControlLowOutput, QLabel#labelCoinControlAfterFeeText, QLabel#labelCoinControlAfterFee, QLabel#labelCoinControlChangeText, QLabel#labelCoinControlChange, QLabel#labelCoinControlChangeLabel{ background: rgb(255, 255, 255); }"
                  "QPushButton#sendButton{ background: rgb(191, 29, 44); color: rgb(255, 255, 255); }"
                  "QPushButton#sendButton:hover{ background: rgb(255, 255, 255); color: rgb(0, 0, 0); border: 2px solid red; }"
                  "QPushButton#sendButton:pressed{ background: rgb(255, 0, 0); color: rgb(255, 255, 255); }"
                 );
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter an Eltoken address (e.g. E8gZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    case WalletModel::TransactionCommitFailed:
        QMessageBox::warning(this, tr("Send Coins"),
            ...
            QMessageBox::Ok, QMessageBox::Ok);
        break;
    case WalletModel::LockTxToOthers:
        QMessageBox::warning(this, tr("Send Coins"),
            tr("Error: The transaction was rejected, can only send to yourself with locked function."),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid Eltoken address"));
        }
        else
        {
